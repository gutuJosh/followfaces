...
<br/>
Now will pass to the post-production phase. You will have to merge the fisrt 8 shots in the same order in which they where made, ending with an eight frame filmstrip. Use Adobe Photoshop or other image manipulation softwere, to do that.
